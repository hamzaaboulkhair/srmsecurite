...
import 'ResponsableActionDetailScreen.dart';

class ResponsableActionScreen extends StatefulWidget {
  final Map<String, dynamic> visite;

  const ResponsableActionScreen({super.key, required this.visite});

  @override
  _ResponsableActionScreenState createState() => _ResponsableActionScreenState();
}

class _ResponsableActionScreenState extends State<ResponsableActionScreen> {
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ResponsableActionDetailScreen(actionId: action['id'], action: action),
                  ),
                );
              },
